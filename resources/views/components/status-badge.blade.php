...
$map = [
    ...
    'confirmed' => ['Dikonfirmasi Mitra', 'bg-blue-50 text-blue-700 ring-blue-200'],
    'ready_pickup' => ['Siap Diambil', 'bg-cyan-50 text-cyan-700 ring-cyan-200'],
    'ongoing' => ['Sedang Disewa', 'bg-sky-50 text-sky-700 ring-sky-200'],
    'returned' => ['Dikembalikan', 'bg-violet-50 text-violet-700 ring-violet-200'],
    ...
    'archived' => ['Diarsipkan', 'bg-slate-200 text-slate-700 ring-slate-300'],
