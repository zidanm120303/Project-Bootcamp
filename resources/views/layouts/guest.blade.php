...
<main class="grid min-h-screen lg:grid-cols-[.9fr_1.1fr]">
    ...
    <section class="relative hidden overflow-hidden bg-ink lg:block">
        <img src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=1400&q=90" class="absolute inset-0 h-full w-full object-cover opacity-55" alt="Kamera profesional RentalPro">
        ...
        <div class="relative flex h-full flex-col justify-between p-12 text-white">
            ...
            <div class="max-w-xl"><span class="grid h-14 w-14 place-items-center rounded-2xl bg-white/15 backdrop-blur"><x-icon name="shield" class="h-7 w-7" /></span><h1 class="mt-6 text-4xl font-black leading-tight">Sewa kamera mudah.<br>Jadwal tetap aman.</h1><p class="mt-4 max-w-md leading-7 text-indigo-100/80">Marketplace rental kamera dengan unit terdata, pembayaran terverifikasi, dan alur booking transparan.</p><div class="mt-8 flex gap-6 text-sm"><span>✓ Mitra terverifikasi</span><span>✓ Jadwal tervalidasi</span></div></div>
        </div>
    </section>
</main>
</body>
